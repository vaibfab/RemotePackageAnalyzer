 ...
 * Public Interfaces:
 * ------------------
 * Toker objToker=new Toker();              //Creates new Toker object.
 * toker.open(filePath);                    //Opens a new file and assign it to tokenizer
 * toker.getTok();                          //returns tokens, one at a time.
 * 
 * Maintenance History
 * -------------------
 * ver 1.3 : 05 Oct 2018
