...
namespace CsGraph
{
    ...
    public class CsEdge<V, E>:IEnumerable<CsNode<string,string>>  // holds child node and instance of edge type E
    {
        ...
        public IEnumerator<CsNode<string, string>> GetEnumerator()
        {
